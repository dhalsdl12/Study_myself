...
#randrange(): 지정한 범위 사이의 float를 리턴합니다.
...
num = [1,2,3,4,5]
print("- choice([1,2,3,4,5]): ", random.choice(num))

#shuffle(list): 리스트의 요소들을 랜덤하게 섞습니다.
print("- shuffle([1,2,3,4,5]): ", random.shuffle(num))

#sample(list, k=<숫자>): 리스트의 요소 중에 k개를 뽑습니다.
print("- sample([1,2,3,4,5]): ", random.sample(num))